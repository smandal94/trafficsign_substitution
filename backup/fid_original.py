...
https://raw.githubusercontent.com/bioinf-jku/TTUR/master/fid.py
'''
...
def load_image_batch(files):
    ...
    img_list = []
    for fn in files:
        img = cv2.imread(str(fn), 1)[:,:,::-1]
        img = cv2.resize(img, (64, 64), None, interpolation=cv2.INTER_NEAREST)
...
if __name__ == "__main__":
    ...
    print("FID: {:.02f}".format(fid_value))
