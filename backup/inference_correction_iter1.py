...
def main():
    ...
    save_dir = '/media/sayan/sayan/projects/traffic_sign/dataset/DFG_traffic_sign_dataset/results/DFG_resultcrops/iter1'
        ...
        for img, target, img_path in zip(images, targets, img_paths):
            ...
            for msk, bxs, lbl, annot_id in zip(masks, boxes, labels, annot_ids):
                ...
                try:
                    ...
                    # cv2.imshow('aligned_result', aligned_result)
                ...
                save_pathS = '{}/synthetic/{:06d}.png'.format(save_dir, annot_id)
                cv2. imwrite(save_pathS, poisson[ymin:ymax, xmin:xmax, :])
