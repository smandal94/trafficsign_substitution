...
parser.add_argument('--batch_size', type=int, default=16, help='image size')
...
def main():
    ...
    wandb.login()
    wandb_logger = WandbLogger(project="TrafficSign", group="CycleGAN_tryout", config=opt)
